    ...
    return (
        <main className="min-h-screen bg-[#0a051e] text-white">
            ...
            <div className="container mx-auto px-4 pt-32 pb-32 max-w-4xl relative z-10">
                <h1 className="text-4xl font-bold mb-8 text-gradient">{t.legal.terms.title}</h1>
                <div className="glass-card p-8 rounded-3xl space-y-8 text-gray-300 leading-relaxed">
                    <div className="space-y-4">
                        <p className="text-sm text-gray-400 italic">{t.legal.terms.lastUpdated}</p>
                        {t.legal.terms.description && (
                            <p className="text-lg font-medium text-gray-200">{t.legal.terms.description}</p>
                        )}
                    </div>
